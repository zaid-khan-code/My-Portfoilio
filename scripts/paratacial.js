...
export let praticals = ` <div class="pratical leftAnRightAnime relative h-[4px] w-[4px] shadow-[inset_0_0_20px_5px_rgba(0,191,255,0.3)] rounded-full bg-[hsl(191,95%,55%)] opacity-30"></div>
                <div class="pratical leftAnRightAnime "></div>
                <div class="pratical leftAnRightAnime "></div>
                <div class="pratical leftAnRightAnime "></div>
                <div class="pratical leftAnRightAnime "></div>
                <div class="pratical leftAnRightAnime "></div>
